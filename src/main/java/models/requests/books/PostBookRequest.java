 ...
 */
public class PostBookRequest extends BookModel {

    public PostBookRequest(Long id, String title, String description, int pageCount, String excerpt, String publishDate) {
    ...
    public boolean equals(Object o) {
        ...
        PostBookRequest that = (PostBookRequest) o;
    ...
    public String toString() {
        return String.format("PostBookRequest{id=%d, title='%s', description='%s', pageCount=%d, excerpt='%s', publishDate='%s'}",
